-- Pro monthly Labs total: 150 → 90 (tier sub-caps unchanged: 15/day, 120/15/15).
...
comment on function public.consume_labs_scan(uuid, text) is 'Labs quota: active pro (90/mo, 15/day, 120/15/15 tiers) or proplus (450/mo, 40/day, 360/45/45 tiers).';
