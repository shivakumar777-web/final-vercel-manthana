...
const PLANS: PlanDef[] = [
  ...
  },
  {
    ...
    highlighted: true,
    features: [
      `${PRO_LABS_LIMITS.totalMonthly} Labs scans/month (max ${PRO_LABS_LIMITS.dailyMax}/day, UTC) — fair use`,
      "1D and 2D complete unlocks on supported modalities (e.g. ECG strips, imaging stacks)",
      "95-modality AI analysis — multi-model orchestration",
      "Manthana Oracle: premium medical models (M5, clinical); no 3D volumetric imaging",
